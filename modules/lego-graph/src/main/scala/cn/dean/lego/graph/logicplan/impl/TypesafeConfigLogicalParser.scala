package cn.dean.lego.graph.logicplan.impl
...
import cn.dean.lego.graph.logicplan.LogicalParser
...
/**
  ...
  */
class TypesafeConfigLogicalParser(implicit injector: Injector) extends LogicalParser[Config, NodeProp] {
